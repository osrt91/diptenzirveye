    ...
    <div className="space-y-8 max-w-2xl">
      <div>
        ...
        <p className="text-dz-grey-600 dark:text-dz-grey-400 text-sm">
          Platform bağlantıları ve özellikleri doğrulama ekranı.
        </p>
      </div>
      ...
      <section className="rounded-xl border border-dz-grey-200 dark:border-dz-grey-800 p-5 space-y-4">
        ...
        <ul className="space-y-2 text-sm">
          ...
          <li className="flex items-center gap-2">
            ...
            <span>Liderlik Tablosu (get_leaderboard)</span>
          </li>
          <li className="flex items-center gap-2">
      ...
      <section className="rounded-xl border border-dz-grey-200 dark:border-dz-grey-800 p-5 space-y-4">
        ...
        <ul className="grid gap-2 text-sm">
          {[
            { label: "Ana sayfa + bekleme listesi", path: "/" },
            { label: "Kayıt / giriş / e-posta doğrulama", path: "/giris" },
            { label: "Kontrol Merkezi (XP, seri, görevler)", path: "/panel" },
            ...
            { label: "Zihin Motoru", path: "/panel/pomodoro" },
            { label: "Eylem İvmesi Serisi", path: "/panel/erteleme" },
            { label: "Not defteri", path: "/panel/not-defteri" },
            { label: "Sohbet", path: "/panel/sohbet" },
            { label: "Liderlik tablosu", path: "/panel/siralama" },
            { label: "Proje Planlayıcı", path: "/panel/proje-planlayici" },
            { label: "Prompt Kütüphanesi", path: "/panel/prompt-hub" },
            { label: "Günlük Görev", path: "/panel/prompt-challenge" },
          ].map(({ label, path }) => (
