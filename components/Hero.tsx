    ...
    <section className="relative min-h-screen flex flex-col justify-center px-4 py-20 overflow-hidden bg-dz-white dark:bg-dz-black">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center mt-12">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-dz-orange-500/20 bg-dz-orange-500/5 mb-8 backdrop-blur-md"
        >
          <span className="flex h-2 w-2 rounded-full bg-dz-orange-500 animate-pulse"></span>
          <span className="font-mono text-xs tracking-widest text-dz-orange-600 dark:text-dz-orange-400 uppercase font-bold">
        ...
        {/* MAIN TITLE */}
        <motion.h1
          className="font-display text-5xl sm:text-7xl md:text-8xl font-black tracking-tighter text-dz-black dark:text-dz-white mb-6 leading-[1.1]"
        >
          <motion.span
        ...
        >
          ...
          <Link
            href="/panel-onizleme"
            className="group flex items-center justify-center gap-3 px-10 py-5 rounded-2xl bg-dz-grey-100 dark:bg-dz-grey-900 border border-dz-grey-200 dark:border-dz-grey-800 text-dz-black dark:text-dz-white font-semibold text-lg hover:bg-dz-grey-200 dark:hover:bg-dz-grey-800 hover:border-dz-grey-300 dark:hover:border-dz-grey-600 transition-all duration-300 w-full sm:w-auto"
          >
            Akademiye Giriş
          </Link>
        </motion.div>
        ...
        >
          <span className="flex items-center gap-2">
            <svg className="w-5 h-5 text-dz-amber-400" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
