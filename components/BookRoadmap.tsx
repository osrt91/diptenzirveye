...
type BookStep = { n: string; verb: string; title: string; desc: string; icon: any; color: string; free?: boolean; pages: string; prompts: string };
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6">
          {books.map((b, i) => (
            ...
            >
              ...
              <div className={`relative h-full min-h-[380px] rounded-2xl transition-transform duration-500 group-hover:-translate-y-2 ${!b.free ? 'opacity-90 grayscale-[10%] group-hover:grayscale-0' : ''}`}>
                <div className="absolute inset-0 bg-dz-white dark:bg-dz-white/[0.03] backdrop-blur-xl border border-dz-grey-200 dark:border-dz-white/10 rounded-2xl flex flex-col p-6 z-10 overflow-hidden shadow-lg dark:shadow-[10px_10px_30px_rgba(0,0,0,0.4)] group-hover:shadow-2xl group-hover:border-dz-orange-300 dark:group-hover:border-dz-orange-500/30 transition-all duration-500">
