...
export default function NotEditor({
  id,
  initialTitle,
  initialContent,
}: {
  ...
  return (
    <div className="space-y-4">
      ...
      <textarea
        ...
        rows={16}
        className="w-full rounded-lg border border-dz-grey-200 dark:border-dz-grey-700 bg-dz-grey-100/50 dark:bg-dz-grey-900/50 p-4 text-foreground"
        placeholder="İçerik..."
      />
    </div>
  );
