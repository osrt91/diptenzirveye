              ...
              >
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-dz-grey-500 leading-relaxed">
                    <span className="font-display"><span className="font-black">Dipten</span><span className="font-normal text-dz-orange-500">Zirveye</span></span>&apos;de seni görmek harika! Kişisel gelişim
