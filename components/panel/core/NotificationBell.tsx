        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 top-12 z-50 w-80 max-h-[420px] rounded-2xl border border-dz-grey-200 dark:border-dz-grey-800 bg-dz-white dark:bg-dz-grey-900 shadow-2xl overflow-hidden"
            >
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-xs text-dz-grey-500 line-clamp-2 mt-0.5">
                            {notif.message}
                          </p>
